      ...
      <div className="container mx-auto pt-16 pb-6 lg:pt-24">
        <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
          <div>
            ...
            <form className="mt-8 px-6 md:px-0">
              <Label
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2 md:grid-cols-4 lg:col-span-2">
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                <li>
                  <a
                    className="text-slate-600 dark:text-slate-200 transition hover:topacity-75"
                    href="#"
                  >
                    Company History
                  </a>
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li>
                  <a
                    ...
                    href="#"
                  >
                    <span className="text-slate-600 dark:text-slate-200 transition group-hover:opacity-75">
                      Live Chat
                    </span>
            ...
            <div className="text-center sm:text-left">
              ...
              <ul className="mt-8 space-y-4 text-sm">
                ...
                <li className="flex items-start justify-center gap-1.5 ltr:sm:justify-start rtl:sm:justify-end">
                  ...
                  <address className="-mt-0.5 flex-1 text-slate-700 dark:text-slate-200 not-italic">
                    Kimathi Street, IPS Building, 6th floor.
                  </address>
                </li>
              </ul>
            </div>
        ...
        <div className="mt-12 border-t pt-6">
          <div className="text-center sm:flex sm:justify-between sm:text-left">
            <p className="text-sm space-x-2">
              ...
              <a
                className="inline-block text-slate-600 dark:text-slate-300 underline transition hover:text-slate-600/75 dark:hover:text-white"
                href="#"
              >
                Terms & Conditions
              </a>
            ...
            <p className="mt-4 text-sm sm:order-first sm:mt-0">
              &copy; {new Date().getFullYear()} Autohub INC
            </p>
          </div>
        </div>
      </div>
